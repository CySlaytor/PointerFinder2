...
namespace PointerFinder2.Emulators.StateBased.DuckStation
{
    public class DuckStationStateBasedScannerStrategy : StateBasedScannerStrategyBase
    {
        // Scans the single 2MB PS1 RAM dump to build the pointer map.
