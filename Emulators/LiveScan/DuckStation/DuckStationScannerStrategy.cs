...
namespace PointerFinder2.Emulators.LiveScan.DuckStation
{
    public class DuckStationScannerStrategy : LiveScannerStrategyBase
    {
        // Scans the single 2MB PS1 RAM region in parallel chunks to build the pointer map.
        ...
        // DuckStation has no address mirroring, so this is a simple lookup.
